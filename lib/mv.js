var mv = (function () {
    ...
    return {
            ...
            selected_layers.each(function(i,ctl) {
                if (ctl.checked) {
                    ...
                    $(".layers-list-item.active")
                        ...
                        .attr("data-tooltipenabled", "true")
                        .attr("data-exclusive", "true")
                        .attr("data-showintoc", "true")
                        .attr("data-toplayer", "true")
        ...
        showLayerOptions: function (el) {
            ...
            $("#frm-exclusive").prop("checked", (layer.exclusive));
            $("#frm-tooltip").prop("checked", (layer.tooltip));
            $("#frm-tooltip").prop("checked", (layer.tooltipenabled));
            $("#frm-showintoc").prop("checked", (layer.showintoc));
            $("#frm-toplayer").prop("checked", (layer.toplayer));
        ...
        saveLayerOptions: function () {
            ...
            layer.exclusive = ($("#frm-exclusive").prop("checked") === true);
            layer.tooltip = ($("#frm-tooltip").prop("checked") === true);
            layer.tooltipenabled = ($("#frm-tooltip").prop("checked") === true);
            layer.showintoc = ($("#frm-showintoc").prop("checked") === true);
            layer.toplayer = ($("#frm-toplayer").prop("checked") === true);
        ...
        parseApplication(xml) {
            ...
            ["exportpng", "measuretools", "showhelp", "coordinates", 
                "togglealllayersfromtheme", "fullscreen"].forEach(function(value,id) {
            ...
            themes.each(function(id, th) {
                ...
                layers.each(function(id, l) {
                    ...
                    var layer = {
                        ...
                        tooltip: ($(l).attr("tooltip") === "true"),
                        tooltipenabled: ($(l).attr("tooltipenabled") === "true"),
